...
import maybachBrownImg from "@/assets/car-maybach-brown.jpg";
import maybachBlackImg from "@/assets/car-maybach-black.jpg";
import gclassBrabusImg from "@/assets/car-gclass-brabus.jpg";
import gclassWeddingImg from "@/assets/car-gclass-wedding.jpg";
import gclassBrabus2Img from "@/assets/car-gclass-brabus2.jpg";
import gclassWhiteImg from "@/assets/car-gclass-white.jpg";
import bmw535Img from "@/assets/car-bmw-535.jpg";
import mercedesClsImg from "@/assets/car-mercedes-cls.jpg";
...
export const featuredCars: Car[] = [
  ...
  },
  {
    ...
    topSpeed: "250 km/h",
    seats: 4,
    features: ["Maybach Interior", "Two-Tone Paint", "Executive Rear Seats"],
    vendor: "Sayarti Jo",
    vendorVerified: true,
    available: true,
    occasion: ["رجال اعمال", "اعراس"],
    fuelType: "gasoline",
  },
  {
    id: "28",
    ...
    topSpeed: "250 km/h",
    seats: 4,
    features: ["Maybach Wheels", "Burmester 4D", "First Class Rear"],
    vendor: "Sayarti Jo",
    vendorVerified: true,
    available: true,
    occasion: ["رجال اعمال", "اعراس"],
  ...
  },
  {
    ...
    topSpeed: "220 km/h",
    seats: 5,
    features: ["Brabus Kit", "Wedding Ready", "AMG Performance"],
    vendor: "Sayarti Jo",
    vendorVerified: true,
    available: true,
    occasion: ["اعراس", "رجال اعمال"],
  ...
  {
    id: "30",
    name: "G63 AMG Wedding",
    brand: "Mercedes-Benz",
    image: gclassWeddingImg,
    pricePerDay: 0,
    category: "Wedding Cars",
    engine: "4.0L V8 Biturbo",
    acceleration: "4.5s",
    topSpeed: "220 km/h",
    seats: 5,
    features: ["Wedding Package", "Flower Decoration", "AMG Styling"],
    vendor: "Sayarti Jo",
    vendorVerified: true,
    available: true,
    occasion: ["اعراس"],
  ...
  },
  {
    ...
    topSpeed: "220 km/h",
    seats: 5,
    features: ["Brabus Wide Body", "LED Roof Bar", "Wedding Ready"],
    vendor: "Sayarti Jo",
    vendorVerified: true,
    available: true,
    occasion: ["اعراس", "رجال اعمال"],
  ...
  },
  {
    ...
    topSpeed: "220 km/h",
    seats: 5,
    features: ["Brabus Kit", "Red Interior", "Night Package"],
    vendor: "Sayarti Jo",
    vendorVerified: true,
    available: true,
    occasion: ["اعراس", "رجال اعمال", "استخدام شخصي"],
  ...
  },
  {
    ...
    topSpeed: "250 km/h",
    seats: 5,
    features: ["M Sport Package", "Sport Seats", "19\" M Wheels"],
    vendor: "Sayarti Jo",
    vendorVerified: true,
    available: true,
    occasion: ["رجال اعمال", "استخدام شخصي"],
  ...
  },
  {
    ...
    topSpeed: "250 km/h",
    seats: 5,
    features: ["AMG Line", "Multibeam LED", "Widescreen Cockpit"],
    vendor: "Sayarti Jo",
    vendorVerified: true,
    available: true,
    occasion: ["رجال اعمال", "اعراس", "استخدام شخصي"],
